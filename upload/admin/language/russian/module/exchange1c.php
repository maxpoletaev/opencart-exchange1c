...
$_['entry_exportfilters'] 	= 'Создавать фильтры при экспорте:';
$_['entry_exportfilters_help'] 	= 'Перед экспортом данных, необходимо создать группы фильтров которые необходимо загрузить. Название группы фильтра должно соответствовать наименованию "Свойства" в 1С';
