...
$_['autofill_image_category_help']	= 'Если указано значение будет выполнен поиск изображения по данному пути относительно каталого images. Формат изображения jpg. Название изображения должно соответствовать названию категории в транслите (пробелы и спецсимволы заменяются на подчеркивание)';
$_['autofill_image_options']	= 'Автоматически назначать изображения опциям товаров';
$_['autofill_image_options_help']	= 'Если указано значение будет выполнен поиск изображения по данному пути относительно каталого images. Формат изображения jpg. Название изображения должно соответствовать названию опции в транслите (пробелы и спецсимволы заменяются на подчеркивание)';
