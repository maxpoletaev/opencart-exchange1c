...
$_['entry_price_type']			 = 'Тип выгружаемой цены';
...
$_['entry_notify'] 		 = 'Уведомлять пользователей о смене статуса';
$_['entry_use_utf8'] 	 = 'Использовать UTF-8 (если по другому не работает)';
